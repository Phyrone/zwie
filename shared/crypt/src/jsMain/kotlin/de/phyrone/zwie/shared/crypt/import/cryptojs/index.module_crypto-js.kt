...
typealias WordArray = global.CryptoJS.lib.WordArray

typealias CipherParams = global.CryptoJS.lib.CipherParams
...
inline operator fun CipherOption.get(key: String): Any? = asDynamic()[key]

@Suppress("NOTHING_TO_INLINE")
inline operator fun CipherOption.set(key: String, value: Any) {
    asDynamic()[key] = value
}
