...
import org.w3c.xhr.*
import enums.hash
import enums.symmetric
import enums.compression
import tsstdlib.Set
import enums.aead
import enums.publicKey
import enums.curve
import tsstdlib.Partial
import enums.packet
import enums.literal
import enums.signature
import enums.reasonForRevocation
import tsstdlib.Map
...
external open class Key {
    ...
    open fun getExpirationTime(userID: UserID = definedExternally, config: Config = definedExternally): Promise<dynamic /* Date? | Any? */>
    open fun getKeyIDs(): Array<KeyID>
    open fun getPrimaryUser(date: Date = definedExternally, userID: UserID = definedExternally, config: Config = definedExternally): Promise<PrimaryUser>
    open fun getUserIDs(): Array<String>
    open fun isPrivate(): Boolean
    open fun toPublic(): PublicKey
    open fun update(sourceKey: PrivateKey, date: Date = definedExternally, config: Config = definedExternally): Promise<PrivateKey>
    ...
    open fun update(sourceKey: PublicKey, date: Date = definedExternally, config: Config = definedExternally): Promise<PublicKey>
    ...
    open fun signPrimaryUser(privateKeys: Array<PrivateKey>, date: Date = definedExternally, userID: UserID = definedExternally, config: Config = definedExternally): Promise<Key /* this */>
    open fun signAllUsers(privateKeys: Array<PrivateKey>, date: Date = definedExternally, config: Config = definedExternally): Promise<Key /* this */>
    open fun verifyPrimaryKey(date: Date = definedExternally, userID: UserID = definedExternally, config: Config = definedExternally): Promise<Unit>
    open fun verifyPrimaryUser(publicKeys: Array<PublicKey>, date: Date = definedExternally, userIDs: UserID = definedExternally, config: Config = definedExternally): Promise<Array<`T$25`>>
    open fun verifyAllUsers(publicKeys: Array<PublicKey>, date: Date = definedExternally, config: Config = definedExternally): Promise<Array<`T$26`>>
    open fun isRevoked(signature: SignaturePacket = definedExternally, key: AnyKeyPacket = definedExternally, date: Date = definedExternally, config: Config = definedExternally): Promise<Boolean>
    open fun getRevocationCertificate(date: Date = definedExternally, config: Config = definedExternally): Promise<dynamic /* String? | WebStream<String>? | NodeStream<String>? */>
    open fun getEncryptionKey(keyID: KeyID = definedExternally, date: Date? = definedExternally, userID: UserID = definedExternally, config: Config = definedExternally): Promise<dynamic /* this | Subkey */>
    open fun getSigningKey(keyID: KeyID = definedExternally, date: Date? = definedExternally, userID: UserID = definedExternally, config: Config = definedExternally): Promise<dynamic /* this | Subkey */>
...
external open class PrivateKey(packetlist: PacketList<Any /* BasePacket | UnparseablePacket */>) : PublicKey {
    open fun revoke(reason: ReasonForRevocation = definedExternally, date: Date = definedExternally, config: Config = definedExternally): Promise<PrivateKey>
    open fun isDecrypted(): Boolean
    open fun addSubkey(options: SubkeyOptions): Promise<PrivateKey>
    open fun getDecryptionKeys(keyID: KeyID = definedExternally, date: Date? = definedExternally, userID: UserID = definedExternally, config: Config = definedExternally): Promise<dynamic /* PrivateKey | Subkey */>
...
external open class CleartextMessage {
    ...
    open fun sign(privateKeys: Array<PrivateKey>, signature: Signature = definedExternally, signingKeyIDs: Array<KeyID> = definedExternally, date: Date = definedExternally, userIDs: Array<UserID> = definedExternally, config: Config = definedExternally)
    open fun verify(keys: Array<PublicKey>, date: Date = definedExternally, config: Config = definedExternally): Promise<Array<VerificationResult>>
}
...
external open class Message<T>(packetlist: PacketList<Any /* BasePacket | UnparseablePacket */>) {
    ...
    open fun write(): dynamic /* Uint8Array | WebStream<Uint8Array> | NodeStream<Uint8Array> */
    open fun armor(config: Config = definedExternally): String
    open fun decrypt(decryptionKeys: Array<PrivateKey> = definedExternally, passwords: Array<String> = definedExternally, sessionKeys: Array<SessionKey> = definedExternally, date: Date = definedExternally, config: Config = definedExternally): Promise<Message<dynamic /* Uint8Array | String | WebStream<dynamic /* Uint8Array | String */> | NodeStream<dynamic /* Uint8Array | String */> */>>
    open fun encrypt(encryptionKeys: Array<PublicKey> = definedExternally, passwords: Array<String> = definedExternally, sessionKeys: Array<SessionKey> = definedExternally, wildcard: Boolean = definedExternally, encryptionKeyIDs: Array<KeyID> = definedExternally, date: Date = definedExternally, userIDs: Array<UserID> = definedExternally, config: Config = definedExternally): Promise<Message<dynamic /* Uint8Array | String | WebStream<dynamic /* Uint8Array | String */> | NodeStream<dynamic /* Uint8Array | String */> */>>
    open fun getEncryptionKeyIDs(): Array<KeyID>
    open fun getLiteralData(): Any?
    open fun getSigningKeyIDs(): Array<KeyID>
    open fun getText(): Any?
    open fun getFilename(): String?
    open fun sign(signingKeys: Array<PrivateKey>, signature: Signature = definedExternally, signingKeyIDs: Array<KeyID> = definedExternally, date: Date = definedExternally, userIDs: Array<UserID> = definedExternally, config: Config = definedExternally): Promise<Message<T>>
    open fun unwrapCompressed(): Message<T>
    open fun verify(verificationKeys: Array<PublicKey>, date: Date = definedExternally, config: Config = definedExternally): Promise<Array<VerificationResult>>
...
external open class AEADEncryptedDataPacket : BasePacket {
    ...
    open fun crypt(fn: Function<*>, sessionKey: Uint8Array, data: Uint8Array): dynamic /* Uint8Array | WebStream<Uint8Array> | NodeStream<Uint8Array> */
    open fun crypt(fn: Function<*>, sessionKey: Uint8Array, data: LocalWebStream<Uint8Array>): dynamic /* Uint8Array | WebStream<Uint8Array> | NodeStream<Uint8Array> */
    open fun crypt(fn: Function<*>, sessionKey: Uint8Array, data: LocalNodeStream<Uint8Array>): dynamic /* Uint8Array | WebStream<Uint8Array> | NodeStream<Uint8Array> */
...
external open class SignaturePacket : BasePacket {
    ...
    open fun sign(key: SecretKeyPacket, data: Uint8Array, date: Date = definedExternally, detached: Boolean = definedExternally): Promise<Unit>
    ...
    open fun sign(key: SecretSubkeyPacket, data: Uint8Array, date: Date = definedExternally, detached: Boolean = definedExternally): Promise<Unit>
    ...
    open fun verify(key: AnyKeyPacket, signatureType: signature, data: Uint8Array?, date: Date = definedExternally, detached: Boolean = definedExternally, config: Config = definedExternally): Promise<Unit>
    open fun verify(key: AnyKeyPacket, signatureType: signature, data: Uint8Array?): Promise<Unit>
    open fun verify(key: AnyKeyPacket, signatureType: signature, data: Uint8Array?, date: Date = definedExternally): Promise<Unit>
    open fun verify(key: AnyKeyPacket, signatureType: signature, data: Uint8Array?, date: Date = definedExternally, detached: Boolean = definedExternally): Promise<Unit>
    open fun verify(key: AnyKeyPacket, signatureType: signature, data: Any?, date: Date = definedExternally, detached: Boolean = definedExternally, config: Config = definedExternally): Promise<Unit>
    open fun verify(key: AnyKeyPacket, signatureType: signature, data: Any?): Promise<Unit>
    open fun verify(key: AnyKeyPacket, signatureType: signature, data: Any?, date: Date = definedExternally): Promise<Unit>
    open fun verify(key: AnyKeyPacket, signatureType: signature, data: Any?, date: Date = definedExternally, detached: Boolean = definedExternally): Promise<Unit>
...
external fun armor(messagetype: enums.armor, body: Any?, partindex: Number, parttotal: Number, config: Config = definedExternally): String
