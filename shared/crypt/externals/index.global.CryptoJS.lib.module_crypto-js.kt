...
external interface StreamCipher : Cipher {
    var blockSize: Number
}
...
external object SerializableCipher {
    fun encrypt(cipher: CipherStatic, message: Any /* WordArray | String */, key: WordArray, cfg: CipherOption = definedExternally): CipherParams
    fun decrypt(cipher: CipherStatic, ciphertext: Any /* WordArray | String */, key: WordArray, cfg: CipherOption = definedExternally): CipherParams
    fun _parse(ciphertext: Any /* CipherParams | String */, format: Format): CipherParams
}

external object PasswordBasedCipher {
    fun encrypt(cipher: CipherStatic, message: Any /* WordArray | String */, password: String, cfg: CipherOption = definedExternally): CipherParams
    fun decrypt(cipher: CipherStatic, ciphertext: Any /* CipherParams | String */, password: String, cfg: CipherOption = definedExternally): WordArray
}